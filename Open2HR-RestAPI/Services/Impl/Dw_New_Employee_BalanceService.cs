...
namespace Open2HRRestAPI.Services.Impl
{
    ...
    /// </summary>  
    public class Dw_New_Employee_BalanceService : PbServiceBase<Dw_New_Employee_Balance>, IDw_New_Employee_BalanceService
    {
        public Dw_New_Employee_BalanceService(SampleDataContext dataContext) : base(dataContext)
        {
        }
