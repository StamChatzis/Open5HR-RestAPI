...
namespace Open2HRRestAPI.Services.Impl
{
    ...
    /// </summary>  
    public class Dw_Employee_Sv_GridService: IDw_Employee_Sv_GridService
    {

        private readonly SampleDataContext _dataContext;
        private readonly IDw_SequenceService _sequenceService;

        public Dw_Employee_Sv_GridService(SampleDataContext dataContext, IDw_SequenceService sequenceService)
        {
